...
# using correct grammar 1 smoothie vs multiple smoothies
...
while True:
    ...
    if order == "1":
        ...
        orderSum.append(f"Oreo $7.99 * {amount}")
        ...
        orderSum.append(f"Banana & Strawberry $5.99 * {amount}")
        ...
        orderSum.append(f"Peanut Butter $6.99 * {amount}")
        ...
        orderSum.append(f"Blueberry $8.99 * {amount}")
        ...
        orderSum.append(f"Smore $11.99 * {amount}")
